  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <svg width="20" height="20" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-70">
            <path d="M20 2L4 38h8l8-18 8 18h8L20 2z" fill="var(--bronze)" />
            <circle cx="20" cy="20" r="3" fill="var(--champagne)" />
          </svg>
        </button>
